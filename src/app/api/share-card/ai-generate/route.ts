...
export async function POST(req: NextRequest) {
  ...
  const prompt = `Generate a 1080x1080 social media share card image for a LGBT-friendly inclusive religious platform called "Sun City Paris" (gld.pixeeplay.com).
