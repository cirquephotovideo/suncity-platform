...
async function generateHtmlContent(item: any) {
  ...
  const prompt = `Rédige une newsletter hebdo COMPLÈTE pour le site Sun City Paris (réseau social inclusif religieux LGBT+).
...
<h1 style="font-size:22px;color:#d4537e;margin:0 0 16px;">🌈 Sun City Paris</h1>
${body}
