  ...
  try {
    ...
    const html = `
      <div style="font-family:system-ui;max-width:600px;margin:0 auto;padding:24px;background:#fff;color:#222">
        ...
        <p>Bonjour,</p>
        <p>Tu as été invité·e à rejoindre le back-office <strong>Sun City Paris</strong> avec le rôle <strong>${role}</strong>.</p>
        ...
        <p style="font-size:11px;color:#888">
          🌈 Sun City Paris — Mouvement interreligieux pour réconcilier foi et diversité.<br/>
