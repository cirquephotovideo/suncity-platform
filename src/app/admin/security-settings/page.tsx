...
export const metadata = { title: 'Sécurité (super-admin) — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">🛡️ Sécurité (super-admin)</h1>
      <p className="text-textMuted mb-6">Paramètres avancés sécurité : audit, IP whitelist, rate limiting.</p>
