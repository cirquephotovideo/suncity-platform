...
export const metadata = { title: 'Import en masse — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">☁️ Import en masse</h1>
      <p className="text-textMuted mb-6">Upload ZIP de photos ou CSV de données vers MinIO + DB.</p>
