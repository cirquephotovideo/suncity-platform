...
export const metadata = { title: 'Calendrier social — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">📅 Calendrier social</h1>
      <p className="text-textMuted mb-6">Programmation de posts IG/FB/X/TikTok via BullMQ.</p>
