...
export const metadata = { title: 'Invitations admin — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">🔑 Invitations admin</h1>
      <p className="text-textMuted mb-6">Invite d'autres admins/éditeurs par email avec un rôle restreint.</p>
