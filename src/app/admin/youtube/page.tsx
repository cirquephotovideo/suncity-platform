...
export const metadata = { title: 'Vidéos YouTube — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">▶️ Vidéos YouTube</h1>
      <p className="text-textMuted mb-6">Embed YouTube playlist Sun City.</p>
