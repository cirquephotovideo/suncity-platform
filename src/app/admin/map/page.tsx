...
export const metadata = { title: 'Carte mondiale — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">📍 Carte mondiale</h1>
      <p className="text-textMuted mb-6">Vue géographique des contributeurs/clients depuis PageView.country.</p>
