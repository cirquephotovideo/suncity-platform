...
export const metadata = { title: 'Site map (front + back) — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">🗺️ Site map (front + back)</h1>
      <p className="text-textMuted mb-6">Vue d'ensemble de toutes les routes du site et du back-office.</p>
