...
export const metadata = { title: 'Feature flags — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">🚥 Feature flags</h1>
      <p className="text-textMuted mb-6">Activer/désactiver dynamiquement des features sans redéploiement.</p>
