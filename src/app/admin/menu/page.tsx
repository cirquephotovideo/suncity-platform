...
export const metadata = { title: 'Menu nav — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">☰ Menu nav</h1>
      <p className="text-textMuted mb-6">Configurer les entrées du menu public et leur ordre.</p>
