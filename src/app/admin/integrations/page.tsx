...
export const metadata = { title: 'Intégrations — Sun City Admin' };

export default async function Page() {
  await requireAdmin();
  return (
    <div>
      <h1 className="font-display text-3xl mb-4">🔌 Intégrations</h1>
      <p className="text-textMuted mb-6">Configurer Stripe, Resend, Gemini, Telegram, Meta, X, TikTok.</p>
