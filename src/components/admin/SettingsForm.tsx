...
const GROUPS: Group[] = [
  {
    ...
    fields: [
      { key: 'site.title', label: 'Nom du site', placeholder: 'Sun City Paris' },
      ...
      { key: 'site.contactEmail', label: 'Email de contact public', placeholder: 'hello@suncity-platform.com' }
    ]
  },
  {
    title: 'Gemini IA',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'integrations.resend.from', label: 'Adresse expéditeur', placeholder: '"Sun City Paris" <hello@suncity-platform.com>' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'domains.aliases', label: 'Domaines secondaires (CSV)', placeholder: 'suncity-platform.com, suncity-platform.fr' },
