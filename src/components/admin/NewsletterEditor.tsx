  ...
  async function aiDraft() {
    ...
    try {
      const r = await fetch('/api/ai/text', {
        ...
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          prompt: `Rédige une newsletter mensuelle pour le mouvement Sun City Paris. Sujet du mois : témoignages reçus, actions à venir. Ton inclusif, apaisé, simple. Format HTML simple, max 200 mots, sans <html> tag wrapper.`,
          system: 'Tu es l\'éditorialiste du mouvement Sun City Paris. Tu écris en français, ton chaleureux et lumineux.'
        })
      });
      const j = await r.json();
      setHtml(j.text || html);
    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-4">
      ...
      <label className="block">
        ...
        <input
          ...
          placeholder="🌈 Newsletter d'avril — Sun City Paris"
        />
      </label>
            ...
            <div className="p-5">
              <div className="bg-zinc-100 border border-zinc-300 rounded-lg overflow-hidden">
                <div className="bg-zinc-200 px-4 py-2 border-b border-zinc-300 text-zinc-700 text-xs">
                  <strong>De :</strong> Sun City Paris &nbsp;·&nbsp; <strong>Sujet :</strong> {subject || '(vide)'}
                </div>
                <iframe
