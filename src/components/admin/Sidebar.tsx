...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/claude-workspace', label: 'Claude Workspace', emoji: '🍳', soon: true },
      { href: '/admin/claude-cli', label: 'Claude CLI online', emoji: '🍳', soon: true },
      { href: '/admin/vscode-online', label: 'VS Code online', emoji: '💻', soon: true },
      { href: '/admin/feature-chat', label: 'Feature Chat IA', emoji: '💡', soon: true },
      { href: '/admin/time-machine', label: 'Time Machine', emoji: '⏰', soon: true },
      { href: '/admin/invitations', label: 'Invitations admin', emoji: '🔑', soon: true },
      { href: '/admin/security-2fa', label: 'Mon 2FA TOTP', emoji: '🔐', soon: true },
      { href: '/admin/secrets', label: 'Secrets manager', emoji: '🔑', soon: true },
      { href: '/admin/tasks', label: 'Tasks board', emoji: '✅', soon: true },
      { href: '/admin/leads', label: 'Leads CRM', emoji: '🎯', soon: true },
      { href: '/admin/leads/scraper', label: 'Scraper Leads', emoji: '🕸️', soon: true },
      { href: '/admin/mail-setup', label: 'Templates emails', emoji: '✉️', soon: true },
      { href: '/admin/webmail', label: 'Webmail', emoji: '📧', soon: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/ai-settings', label: 'AI Settings (multi-providers)', emoji: '🧠', soon: true },
      { href: '/admin/ai-autopilot', label: 'AI Autopilot', emoji: '🤖', soon: true },
      { href: '/admin/manuals', label: 'Manuels auto IA', emoji: '📚', soon: true },
      { href: '/admin/rag', label: 'Cerveau RAG (knowledge base)', emoji: '🧠', soon: true },
      { href: '/admin/brain-3d', label: 'Brain 3D (visualisation JARVIS)', emoji: '🧠', soon: true },
      { href: '/admin/playground-rag', label: 'Playground RAG (ADMIN-only)', emoji: '💬', soon: true },
      { href: '/admin/scraper', label: 'Scraper polite-fetch', emoji: '🕸️', soon: true },
      { href: '/admin/legal-assistant', label: 'Assistant juridique FR', emoji: '⚖️', soon: true },
  ...
  },
  {
    ...
    items: [
      { href: '/admin/medias', label: 'Modération', emoji: '🛡️' },
      ...
      { href: '/admin/forum', label: 'Forum (modération)', emoji: '☰', soon: true },
      { href: '/admin/temoignages', label: 'Témoignages vidéo', emoji: '📹', soon: true },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/dropshipping', label: 'Dropshipping', emoji: '🚚', soon: true },
    ],
  },
  {
