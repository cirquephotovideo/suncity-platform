...
• autoriser le mouvement Sun City Paris à utiliser cette image gratuitement, dans le monde entier, pour ses communications (site web, réseaux sociaux, newsletters, affiches, supports promotionnels et tout autre support de communication relatif au mouvement) ;
• comprendre que la photo pourra être éditée, recadrée, ou floutée pour préserver la vie privée des personnes visibles.

Vous pouvez à tout moment demander le retrait d'une photo en écrivant à contact@suncity-platform.org.`;
        ...
        <div className="px-5 pb-2 space-y-3">
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            <input type="checkbox" checked={agreePromo} onChange={(e) => setAgreePromo(e.target.checked)}
                   className="mt-1 w-5 h-5 accent-brand-pink shrink-0" />
            <span className="text-sm text-white/90">
              <strong>J'autorise</strong> Sun City Paris à utiliser cette image dans toutes ses communications
